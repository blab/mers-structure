...
As stated in the reply to Reviewer \#1's comment 6.3, the sample mean is the sufficient statistic for $R0$ and the MLE for the dispersion parameter depends on the sample mean and standard deviation only.
...
This does not seem to affect any of our results.}
